    ...
    if(info.mode=="auth"){
      ...
      if((sender in users) && (target in users)){
        ...
        if(users[sender]["instance"] == users[target]["instance"]){
          ...
          if(target in sockets){
            ...
            const offer_msg = {"mode":"offer","sender":sender,"description":description};
            uws.send(JSON.stringify(offer_msg));
          }
        }
      }
      ...
      if((sender in users) && (target in users)){
        ...
        if(users[sender]["instance"] == users[target]["instance"]){
          ...
          if(target in sockets){
            const uws = sockets[target];
            const answer_msg = {"mode":"answer","sender":sender,"description":description};
            uws.send(JSON.stringify(answer_msg));
          }
        }
      }
